...
export const attractions: Attraction[] = [
  {
    ...
    metaDescription: 'Book Eiffel Tower tickets and tours in Paris. 4 top-rated options from £15, with reserved and summit access, instant confirmation and mobile tickets.',
    intro: 'Compare the best Eiffel Tower tickets and guided tours in Paris, ranked by verified reviews. Booking online guarantees entry and unlocks skip-the-line access where offered. Check the cancellation terms before you book: most Eiffel Tower options are non-refundable or refund only 50%. Every option below links straight to GetYourGuide.',
    ...
    faqs: [
      ...
      { question: 'What is the best Eiffel Tower tour?', answer: 'The most-reviewed option is the 1-Hour Seine Cruise from the Eiffel Tower, rated 4.4 stars by 88,160 travellers, from £15. For the tower itself, the Eiffel Tower Entry Ticket with Summit Access starts from £21.' },
  ...
  },
  {
    ...
    metaDescription: 'Seine river cruise tickets and prices in Paris for 2026. Compare daytime cruises from £15, evening lights cruises from £15 and dinner cruises from £98, with departure points for each operator.',
    intro: 'Seine river cruise tickets start from £15 for a one-hour daytime sightseeing sailing, run £15 to £21 for an evening lights cruise, and reach £98 for a dinner cruise with three or four courses. The price table and operator guide below show what each ticket buys and where each boat leaves from, so you can pick before you book. Every option links straight to GetYourGuide for live prices and availability.',
...
<tbody>
<tr><td>1-Hour Seine Cruise from the Eiffel Tower</td><td><strong>&pound;15</strong></td><td>4.4 (88,160)</td><td>Daytime, audio commentary</td></tr>
<tr><td>Evening Lights Cruise with Bateaux-Mouches</td><td><strong>&pound;15</strong></td><td>4.3 (2,199)</td><td>Evening, 70 min to 1.5 hrs</td></tr>
<tr><td>Evening River Cruise with Music</td><td><strong>&pound;21</strong></td><td>4.4 (25,044)</td><td>Evening, background music</td></tr>
<tr><td>Bateaux Mouches Dinner Cruise</td><td><strong>&pound;98</strong></td><td>4.5 (4,248)</td><td>Dinner, live musicians</td></tr>
<tr><td>3-Course Dinner Cruise with Live Music</td><td><strong>&pound;98</strong></td><td>4.7 (8,452)</td><td>Dinner, 2.5 hrs, top-rated</td></tr>
<tr><td>Catacombs Entry &amp; Seine Cruise</td><td><strong>&pound;98</strong></td><td>4.5 (1,483)</td><td>Combined ticket</td></tr>
</tbody>
</table>
</div>
...
<p>The route is broadly the same whichever you pick: the loop takes in the Louvre, the Musee d'Orsay, the Conciergerie, Notre-Dame and the Eiffel Tower. What changes is the boarding point, the boat and whether you get commentary, music or dinner. Pick the pier closest to where your day already is.</p>`,
      },
      {
        ...
        content: `<p>The short answer on cost: <strong>&pound;15 by day, &pound;15 to &pound;21 by night, and about &pound;98 with dinner</strong>. Children's fares and combination tickets vary by operator, and prices move with season and demand, so the from-price on each option above is the live figure rather than a printed rate card.</p>
<p>On timing, daytime cruises are better for sightseeing because you can actually see the facades and the audio commentary has something to point at. Evening cruises are better for atmosphere. The one thing worth planning around is the Eiffel Tower sparkle, which runs for five minutes on the hour after dark, so an evening sailing that has you mid-river on the hour is the one to book. In midsummer that means a late departure, since Paris does not go properly dark until close to 10pm.</p>`,
    ...
    faqs: [
      { question: 'How much is the Seine river cruise in Paris?', answer: 'A one-hour daytime sightseeing cruise starts from £15. Evening lights cruises start from £15 to £21, and dinner cruises with three or four courses start from £98. Prices are per person and shown live on each booking page.' },
      ...
      { question: 'What is the best Seine river cruise?', answer: 'The best value is the 1-Hour Seine Cruise from the Eiffel Tower at £15. The highest-rated is the 3-Course Dinner Cruise on the Seine with Live Music, rated 4.7 stars by 8,452 travellers, from £98. For a romantic evening at a low price, the Bateaux-Mouches evening lights cruise from £15 is the pick, though note it is non-refundable.' },
  ...
  },
  {
    ...
    metaDescription: 'Book Louvre Museum tickets and tours in Paris. 3 top-rated options from £50, with reserved and priority access, instant confirmation and free cancellation.',
    ...
    faqs: [
      { question: 'How much are Louvre Museum tickets?', answer: 'Louvre Museum tickets and tours in Paris start from around £50. Guided and skip-the-line options cost a little more. The ranked list shows current prices.' },
      { question: 'What is the best Louvre Museum tour?', answer: 'The top-rated option is the Mona Lisa & Louvre Masterpieces Tour with Reserved Access, rated 4.7 stars by 7,461 travellers, from £50.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What is the best Palace of Versailles tour?', answer: 'The top-rated option is the Versailles Skip-the-Line Palace and Gardens Tour, rated 4.7 stars by 11,551 travellers, from £49.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What is the best Musee d’Orsay tour?', answer: 'The top-rated option is the Musée d’Orsay Skip-the-Line Tour with Expert Guide, rated 4.8 stars by 1,177 travellers, from £60. It is the highest-rated experience anywhere on this site.' },
  ...
  },
  {
    ...
    faqs: [
      ...
      { question: 'What is the best Paris Catacombs tour?', answer: 'The top-rated option is the Catacombs Entry & Seine Cruise with Audio Guide, rated 4.5 stars by 1,483 travellers, from £98. It pairs Catacombs entry with a Seine river cruise.' },
  ...
  },
  {
    ...
    metaDescription: 'Book Disneyland Paris tickets. A top-rated 1-day park ticket from £44, rated 4.6 by 56,303 travellers, with instant confirmation and free cancellation.',
