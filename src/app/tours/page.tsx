...
export const metadata: Metadata = {
  title: 'All Paris Tours & Attractions 2026 | Book Online',
  description: 'Browse and book the best tours and attractions: skip-the-line tickets, guided tours, and day trips. Best prices, instant confirmation, and free cancellation on most bookings.',
  alternates: { canonical: `${SITE_URL}/tours` },
  openGraph: {
    title: 'All Paris Tours & Attractions 2026',
    description: 'Browse and book the best Paris tours and attractions. Best prices, instant confirmation.',
    url: `${SITE_URL}/tours`,
  },
};
  ...
  return (
    <>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl sm:text-4xl font-bold text-gray-900">All Paris Tours & Attractions</h1>
        ...
        <section className="mt-12 bg-gray-50 rounded-xl p-6">
          <h2 className="text-xl font-bold text-gray-900 mb-4">Paris Travel Guides</h2>
          <p className="text-gray-600 mb-4">Not sure where to start? Our guides help you plan the perfect Paris trip.</p>
